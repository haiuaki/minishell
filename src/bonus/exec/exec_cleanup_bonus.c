...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   exec_cleanup_bonus.c                               :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: sopelet <sopelet@student.42.fr>            +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2026/02/19 16:33:45 by sopelet           #+#    #+#             */
/*   Updated: 2026/04/06 21:37:24 by juljin           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "minishell.h"

/* Frees a `t_cmd` node, including any associated subshell command list. */
void	free_cmd_node(t_cmd *node_cmd)
{
	...
	if (node_cmd->bonus.subshell)
		free_cmd_list(node_cmd->bonus.subshell);
	free(node_cmd);
}
