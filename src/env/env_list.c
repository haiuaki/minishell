...
/*   Updated: 2026/04/01 15:10:33 by juljin           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/* Count the number of exported elements with a set value in the env */
...
/* 
 * Helper function to change the value of variable in the `t_env` list
 * referred to by the given key (an existing variable).
